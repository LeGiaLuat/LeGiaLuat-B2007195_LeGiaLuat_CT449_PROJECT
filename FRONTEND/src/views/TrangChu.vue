                        ...
                        <div id="carouselExampleControls" class="carousel slide p-0 m-0" data-bs-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active" id="anhbanner">
                                <img src="@/assets/banner1.jpg" class="d-block w-100" alt="carousel-1">
                                <div class="text">
                                </div>
                              </div>
                              <div class="carousel-item" id="anhbanner">
                                <img src="@/assets/banner2.webp" class="d-block w-100" alt="carousel-2">
                                <div class="text">
                                </div>
                              </div>
                              <div class="carousel-item" id="anhbanner">
                                <img src="@/assets/banner3.jpg" class="d-block w-100" alt="carousel-3">
                                <div class="text">
                                </div> 
                            </div>
                            </div>
