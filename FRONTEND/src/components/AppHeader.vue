<template>
<header class="p-0">
<nav id="menu" class="navbar navbar-expand-lg p-2 bg-info">
<div class="container-fluid p-0">
    ...
    <div class="collapse navbar-collapse col-6" id="navbarSupportedContent">
      ...
      <li class="nav-item btn btn-light m-2 p-0">
        ...
        <li class="nav-item btn btn-light m-2 p-0" v-if="this.user!=null &&this.session_user && this.session_user.id!=null">
          <router-link 
            :to="{
                name: 'DonHang',
